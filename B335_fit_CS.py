...
file_in = 'CS/B335_Combine_CS_rob05_fit1_015kms_2sigma_self_clean.fits'
#rms_file 
file_par = 'CS/Spec_CS_fit_5snr.fits'

#freq_line = 261.84368400 * u.GHz
freq_line = 342.88285030 * u.GHz
...
err_map = np.ones((1800, 1800))*8.84e-4
# Initial guess value
...
if plot_vc:
    ...
    cube = load_myCube( file_in)
    #cube.Registry.add_fitter('n2hp_vtau', pyspeckit.models.n2hp.n2hp_vtau_fitter, 4)
    cube.load_model_fit(file_par, npars=3, npeaks=1, _temp_fit_loc=(xmax,ymax))
    cube.mapplot()
    cube.plot_spectrum(xmax,ymax, plot_fit=True)
